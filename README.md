...
2. Configure the connection string in `PartStockManager.API/appsettings.json` to match your SQL Server instance:
   ```json
   "ConnectionStrings": {
     "DefaultConnection": "Server=YOUR_SERVER;Database=PartStockManagerDb;Trusted_Connection=True;TrustServerCertificate=True;"
   }
   ```
