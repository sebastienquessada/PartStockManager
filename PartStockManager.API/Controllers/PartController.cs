...
namespace PartStockManager.API.Controllers
{
    ...
    public class PartController : ControllerBase
    {
        ...
        public IActionResult ModifyPart([FromBody] PartModificationRequest request)
        {
            ...
            if(updatedPart.StockQuantity < 0 || updatedPart.LowStockThreshold < 0)
            {
                _logger.LogError("ModifyPart failed: The stock quantity and the low stock threshold can't be lower than zero !");
                throw new ArgumentException("Stock values can't be lower than zero !");
            }
