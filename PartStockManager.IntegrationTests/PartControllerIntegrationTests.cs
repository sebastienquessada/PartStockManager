...
namespace PartStockManager.IntegrationTests
{
    public class PartControllerTests : IClassFixture<CustomWebApplicationFactory<Program>>
    {
        ...
        [Fact]
        public async Task Create_Part_Success_Admin_Role()
        {
        ...
        [Fact]
        public async Task Create_Part_Success_Manager_Role()
        {
        ...
        [Fact]
        public async Task Create_Part_Fail_Wrong_User_Right()
        {
            ...
            var request = new PartDto { Reference = "FAILED-WRONG-ROLE", Name = "My Part", StockQuantity = 5, LowStockThreshold = -2 };
        ...
        [Fact]
        public async Task Modify_Part_Success_Admin_Role()
        {
            var token = _factory.GenerateTestToken(UserProfile.Administrator);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
        ...
        [Fact]
        public async Task Modify_Part_Success_Manager_Role()
        {
            var token = _factory.GenerateTestToken(UserProfile.Manager);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
        ...
        [Fact]
        public async Task Modify_Part_Fail_Wrong_User_Right()
        {
            var token = _factory.GenerateTestToken(UserProfile.Stocktaker);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
            ...
            string refTest = "FAILED-WRONG-ROLE";
            _factory.SeedData(db => {
                var entity = new PartEntity
                {
                    Reference = refTest,
        ...
        [Fact]
        public async Task Delete_Part_Success_Admin_Role()
        {
            var token = _factory.GenerateTestToken(UserProfile.Administrator);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
        ...
        [Fact]
        public async Task Delete_Part_Success_Manager_Role()
        {
            var token = _factory.GenerateTestToken(UserProfile.Manager);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
        ...
        [Fact]
        public async Task Delete_Part_Fail_Wrong_User_Right()
        {
            var token = _factory.GenerateTestToken(UserProfile.Stocktaker);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
            ...
            string refTest = "DELETION-FAILED";
            _factory.SeedData(db => {
                var entity = new PartEntity
                {
                    Reference = refTest,
        ...
        [Fact]
        public async Task Get_Parts_With_Name_Admin_Role()
        {
            var token = _factory.GenerateTestToken(UserProfile.Administrator);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
        ...
        [Fact]
        public async Task Get_Parts_With_Name_Manager_Role()
        {
            var token = _factory.GenerateTestToken(UserProfile.Manager);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
        ...
        [Fact]
        public async Task Get_Parts_With_Name_Stocktaker_Role()
        {
            var token = _factory.GenerateTestToken(UserProfile.Stocktaker);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
        ...
        [Fact]
        public async Task Get_Parts_With_Reached_Threshold_Success_Admin_Role()
        {
            var token = _factory.GenerateTestToken(UserProfile.Administrator);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
        ...
        [Fact]
        public async Task Get_Parts_With_Reached_Threshold_Success_Manager_Role()
        {
            var token = _factory.GenerateTestToken(UserProfile.Manager);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
        ...
        [Fact]
        public async Task Get_Parts_With_Reached_Threshold_Success_Stocktaker_Role()
        {
            var token = _factory.GenerateTestToken(UserProfile.Stocktaker);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
